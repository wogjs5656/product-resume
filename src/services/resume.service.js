...
export class ResumeService {
  ...
  createResume = async (userId, resumeTitle, resumeIntro, resumeAuthor) => {
    return await this.resumeRepository.createResume(userId, resumeTitle, resumeIntro, resumeAuthor)
  };
  ...
  updateResume = async(userId ,resumeId, resumeTitle, resumeIntro, resumeStatus) => {
